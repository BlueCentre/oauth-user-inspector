...
const App: React.FC = () => {
  ...
  const exchangeCodeForToken = useCallback(async (code: string, provider: AuthProvider) => {
    setIsLoading(true);
    setError(null);
  ...
  const renderContent = () => {
    ...
    return <LoginScreen onOAuthLogin={handleOAuthLogin} onPatLogin={handlePatSubmit} onGcloudTokenLogin={handleGcloudTokenSubmit} />;
  }
