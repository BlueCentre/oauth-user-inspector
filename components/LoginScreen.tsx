          ...
          <div className="space-y-6">
            ...
            <div className="mt-8 pt-6 border-t border-slate-700">
                ...
                <div className="text-slate-400 space-y-2 text-sm bg-slate-900/50 p-4 rounded-lg border border-slate-700">
                  ...
                  <p>Or uou can use a short-lived token generated by the gh CLI. Note: these tokens typically expire in one hour.</p>
                  <p>Run the following command: <code className="text-xs bg-slate-700 p-1 rounded">gh auth token</code></p>
                </div>
