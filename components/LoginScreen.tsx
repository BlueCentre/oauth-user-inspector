...
const LoginScreen: React.FC<LoginScreenProps> = ({ onOAuthLogin, onPatLogin, onGcloudTokenLogin }) => {
  ...
  return (
    <div className="bg-slate-800 p-8 rounded-xl shadow-2xl ring-1 ring-white/10 w-full max-w-2xl transition-all duration-300">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-700">
          <div className="flex items-center mb-4">
            ...
            <h2 className="ml-3 text-xl font-semibold text-white">Sign in with GitHub</h2>
          </div>
        ...
        <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-700">
          <div className="flex items-center mb-4">
            ...
            <h2 className="ml-3 text-xl font-semibold text-white">Sign in with Google</h2>
          </div>
           <p className="text-sm text-slate-400 mb-2">
      ...
      {/* Token Section */}
      <div className="mt-8 pt-6 border-t border-slate-700 space-y-8">
          {/* GitHub PAT */}
          <div>
